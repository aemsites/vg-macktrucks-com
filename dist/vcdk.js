"use strict";(self.webpackChunkmacktrucks=self.webpackChunkmacktrucks||[]).push([[325],{6487(e,t,i){i.d(t,{E:()=>o});const o=e=>(t,i)=>{const o=()=>{const i=customElements.get(e);if(!i)return void customElements.define(e,t);const o=i.version,r=t.version;o&&r&&o!==r&&console.warn(`vcdk warning: Attempted to register <${e}>v, but <${e}>v. was already registered. This could indicate that your application might contain duplicate instances of the same component.`)};i?i.addInitializer(o):o()}},7502(e,t,i){i.d(t,{m:()=>r});var o=i(2618);const r=e=>"number"==typeof e?e:e||o.s6},4135(e,t,i){i.d(t,{F:()=>l});var o=i(8128),r=i(2618),s=i(2326),n=i(6260);const a=Object.keys(o.f),l=e=>class extends e{static fallbackVariableValue(e,t,i){if(!i.length)return"";const o=i.shift();return i.length?`var(--${e}-${t}-${o}, ${this.fallbackVariableValue(e,t,i)})`:`var(--${e}-${t}-${o})`}static responsiveVariables(e,t,i,o){return t.map(t=>{const r=(0,s.A)(t);return o?`\n    --${e}-${r}-fallback: ${this.fallbackVariableValue(e,r,[...o])};\n    --${e}-${r}: var(--${e}-${r}-${i}, var(--${e}-${r}-fallback));`:`\n    --${e}-${r}: var(--${e}-${r}-${i});`}).join("")}static responsiveStyles(e){return r.AH`
        :host {
...
`;var c=function(e,t,i,o){var r,s=arguments.length,n=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(n=(s<3?r(n):s>3?r(t,i,n):r(t,i))||n);return s>3&&n&&Object.defineProperty(t,i,n),n};class p extends CustomEvent{constructor(e,t){super(e,{detail:t,bubbles:!0,composed:!0,cancelable:!0})}}let h=class extends l.l{constructor(){super(...arguments),this.headerTitle="",this.open=!1,this.onToggleClick=e=>{e.preventDefault();const t=!this.open,i=new p("toggle",{open:t});this.dispatchEvent(i);const o=new p("vcdk-toggle",{open:t});this.dispatchEvent(o);i.defaultPrevented||o.defaultPrevented||(this.open=t)}}render(){const{headerTitle:e,headerIcon:t}=this;return r.qy`
    ...
    `}};h.styles=[o.IT.subtitle1,d],c([(0,s.MZ)({type:String})],h.prototype,"headerTitle",void 0),c([(0,s.MZ)({type:String})],h.prototype,"headerIcon",void 0),c([(0,s.MZ)({type:Boolean,reflect:!0})],h.prototype,"open",void 0),h=c([(0,a.E)("vcdk-accordion")],h)},3254(e,t,i){var o=i(6591),r=i(2618),s=i(352),n=i(3720),a=i(1145),l=i(6487),d=i(4135),c=i(6260);const p=r.AH`
...
`,a=(e,t="small")=>{const i=(0,s.A)(e);return r.AH`
  ...
  `},l=["display-statement","display1","display2","heading1","heading2","heading3","heading4","subtitle1","subtitle2","large-body","body","button","caption1","caption2"].reduce((e,t)=>(e[t]=r.AH`
    ...
    `,e),{}),d=Object.values(l),c=(e,t)=>{const i="font-size"===t?"size":t,o=(0,s.A)(e);return[`var(--vcdk-typography-${o}-${i}-small-screens)`,`var(--vcdk-typography-${o}-${i}-large-screens)`]}},6591(e,t,i){i.d(t,{g:()=>r});i(8128);var o=i(2618);const r={fromAttribute(e,t){if(!e)return null;if(e.startsWith("[")&&e.endsWith("]"))return JSON.parse(e);if(void 0===t){const t=Number(e);if(!Number.isNaN(t))return t}return o.W3.fromAttribute?.(e,t)},toAttribute:(e,t)=>Array.isArray(e)?o.W3.toAttribute?.(e,Array):o.W3.toAttribute?.(e,t)}},6260(e,t,i){i.d(t,{l:()=>o.l});var o=i(2871)},2871(e,t,i){i.d(t,{l:()=>v});var o=i(767);const r=["volvo","mack","renault"];function s(e){return e.includes("light")?e.replace("light","dark"):e.replace("dark","light")}var n=i(2618),a=i(352),l=i(2302);const d=(0,o.q6)(Symbol("vcdk-theme"));if("undefined"!=typeof document){const e=new o.aU,t=()=>e.attach(document.body);document.body?t():document.addEventListener("DOMContentLoaded",t)}const c=n.AH`
  :host {
    --vcdk-z-index-zero: 0;
