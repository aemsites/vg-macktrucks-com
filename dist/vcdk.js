...
`;var b=function(e,t,r,o){var i,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,o);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(n<3?i(s):n>3?i(t,r,s):i(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};let f=class extends l.l{constructor(){super(...arguments),this.ariaLabel="",this.autofocus=!1,this.size="medium",this.variant="marketing",this.clickHandler=e=>{if(!this.href)return this.disabled?(e.preventDefault(),void e.stopPropagation()):void("submit"!==this.type||e.defaultPrevented||this.closest("form")?.requestSubmit())}}render(){const{href:e,variant:t="primary",size:r,loading:o,iconStart:n,iconEnd:a,disabled:d,fullWidth:c,ariaLabel:l,title:p,type:v}=this,h={button:!0,[`variant-${t}`]:!0,[`size-${r}`]:!0,fullWidth:!!c,loading:!!o},y=i.qy`
      ${(0,g.z)(n,()=>i.qy`
          <vcdk-system-icon
            .size=${24}
            .icon=${n}
  ...
  ${f(".skeleton[class*='typography-'].variant-typography","--vcdk-skeleton-line-height")}
  ${f(".skeleton[class*='typography-'].variant-typography","--vcdk-skeleton-font-size")}
...
`;var S=function(e,t,r,o){var i,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,o);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(n<3?i(s):n>3?i(t,r,s):i(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};let M=class extends((0,w.F)(z.l)){constructor(){super(...arguments),this.disableAnimation=!1,this.typographyVariant="body",this.variant="typography",this.elementAriaDescription=null}get cssVariables(){return{...this.typographyVariant&&m("--vcdk-skeleton-line-height",(0,l.UN)(this.typographyVariant,"line-height")),...this.typographyVariant&&m("--vcdk-skeleton-font-size",(0,l.UN)(this.typographyVariant,"font-size"))}}render(){return i.qy`
      <div
        class=${(0,x.H)({skeleton:1,"disable-animation":!!this.disableAnimation,"aspect-ratio":!!this.aspectRatio,[`typography-${this.typographyVariant}`]:!!this.typographyVariant,[`variant-${this.variant}`]:1})}
        style=${(0,$.W)(this.cssVariables)}>
        ${(0,k.z)(this.elementAriaDescription,()=>i.qy`
            <div class="hidden">${this.elementAriaDescription}</div>
          `)}
        <slot aria-hidden="true"></slot>
      </div>
    `}};M.styles=[A,...l.FB],M.responsiveProperties={prefix:"vcdk-skeleton",props:["width","height","size","aspectRatio"]},S([(0,n.MZ)({attribute:"aspect-ratio",converter:p.g})],M.prototype,"aspectRatio",void 0),S([(0,n.MZ)({type:Boolean,attribute:"disable-animation"})],M.prototype,"disableAnimation",void 0),S([(0,n.MZ)({converter:p.g})],M.prototype,"height",void 0),S([(0,n.MZ)({converter:p.g})],M.prototype,"size",void 0),S([(0,n.MZ)({type:String,attribute:"typography-variant"})],M.prototype,"typographyVariant",void 0),S([(0,n.MZ)({converter:p.g})],M.prototype,"width",void 0),S([(0,n.MZ)({type:String})],M.prototype,"variant",void 0),S([(0,n.MZ)({type:String,attribute:"element-aria-description"})],M.prototype,"elementAriaDescription",void 0),M=S([(0,c.E)("vcdk-skeleton")],M);const T=i.AH`
  svg {
    max-width: 100%;
    aspect-ratio: 1 / 1;
    flex-shrink: 0;
...
`;var Z=function(e,t,r,o){var i,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,o);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(n<3?i(s):n>3?i(t,r,s):i(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};const E={};let P=class extends z.l{constructor(){super(...arguments),this.elementRole="presentation",this.elementAriaHidden=null,this.assetsTask=new o.YZ(this,{task:async([e,t,r])=>{if(!e)return"";const o=function({brand:e="volvo",type:t="filled",iconId:r}){return`https://cdn.designsystem.volvogroup.com/1-2-1/icons/${e}/system/${t}/${r}.svg`}({type:t?"filled":"lined",brand:r,iconId:e});return void 0===E[o]&&(E[o]=fetch(o).then(e=>{if(!e.ok)throw new Error(`Response from CDN returned a non ok status: ${e.status}`);return e.text()}).then(e=>(0,a.T)(e)).catch(t=>{throw console.error(`Failed when loading icon id: "${e}". ${t}`),t})),await E[o]},args:()=>[this.icon,this.filled,this.brandId]})}render(){return this.assetsTask.render({pending:()=>i.qy`
        <vcdk-skeleton
          variant="rounded-rectangle"
          size=${(0,s.J)(this.size)}></vcdk-skeleton>
      `,complete:e=>e,error:()=>i.qy`
        <span style="width:${this.size}px;height:${this.size}px"></span>
      `})}updated(e){super.updated(e),this.setAttributes(),this.extendSvg()}extendSvg(){if(this.svgElement){if(this.elementTitle){this.elementAriaLabelledBy=this.elementAriaLabelledBy||(0,d.A)("svg-title-"),this.svgElement.setAttribute("aria-labelledby",this.elementAriaLabelledBy);const e=this.svgElement.querySelector("title");if(e)e.id=this.elementAriaLabelledBy,e.textContent=this.elementTitle;else{if(!document)return void console.warn("Document is not available, cannot create title element for SVG.");const e=document.createElement("title");e.id=this.elementAriaLabelledBy,e.textContent=this.elementTitle,this.svgElement.insertBefore(e,this.svgElement.firstChild)}}if(this.description){this.elementAriaDescribedBy=this.elementAriaDescribedBy||(0,d.A)("svg-description-"),this.svgElement.setAttribute("aria-describedby",this.elementAriaDescribedBy);const e=this.svgElement.querySelector("desc");if(e)e.id=this.elementAriaDescribedBy,e.textContent=this.description;else{const e=document.createElementNS("http://www.w3.org/2000/svg","desc");e.id=this.elementAriaDescribedBy,e.textContent=this.description,this.svgElement.appendChild(e),this.elementTitle?this.svgElement.querySelector("title")?.insertAdjacentElement("afterend",e):this.svgElement.insertBefore(e,this.svgElement.firstChild)}}}}setAttributes(){this.svgElement?.setAttribute("part","svg"),this.svgElement?.setAttribute("focusable","false"),"number"==typeof this.size&&this.svgElement?.setAttribute("style",`--vcdk-system-icon-size: ${this.size}px;`),this.elementRole?this.svgElement?.setAttribute("role",this.elementRole):i.s6,this.elementAriaHidden?this.svgElement?.setAttribute("aria-hidden",this.elementAriaHidden):i.s6}};P.styles=[T],Z([(0,n.MZ)({type:Boolean})],P.prototype,"filled",void 0),Z([(0,n.MZ)({type:String})],P.prototype,"icon",void 0),Z([(0,n.MZ)({type:Number})],P.prototype,"size",void 0),Z([(0,n.MZ)({type:String,attribute:"element-aria-labelledby"})],P.prototype,"elementAriaLabelledBy",void 0),Z([(0,n.MZ)({type:String,attribute:"element-title"})],P.prototype,"elementTitle",void 0),Z([(0,n.MZ)({type:String,attribute:"element-aria-describedby"})],P.prototype,"elementAriaDescribedBy",void 0),Z([(0,n.MZ)({type:String})],P.prototype,"description",void 0),Z([(0,n.MZ)({type:String,attribute:"element-role"})],P.prototype,"elementRole",void 0),Z([(0,n.MZ)({type:String,attribute:"element-aria-hidden"})],P.prototype,"elementAriaHidden",void 0),Z([(0,n.P)("svg")],P.prototype,"svgElement",void 0),Z([(0,n.wk)()],P.prototype,"assetsTask",void 0),P=Z([(0,c.E)("vcdk-system-icon")],P)},1669(e,t,r){r.d(t,{FB:()=>d,IT:()=>a,UN:()=>c});var o=r(8128),i=r(2618),n=r(2326);i.AH`
  slot {
    display: inline;
    font-synthesis: none;
    margin: 0;
...
`;var p=function(e,t,r,o){var i,n=arguments.length,s=n<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,o);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(s=(n<3?i(s):n>3?i(t,r,s):i(t,r))||s);return n>3&&s&&Object.defineProperty(t,r,s),s};class v extends n.WF{constructor(){super(...arguments),this.isThemeProvider=!1,this.themeProvider=void 0,this.themeConsumer=new o.G(this,{context:d,subscribe:!0,callback:()=>{this.handleTheming()}})}static get defaultLocale(){return"undefined"!=typeof document&&document.documentElement.lang?document.documentElement.lang:"undefined"!=typeof window?window.navigator.language:"en-US"}get currentTheme(){let e=this.themeId??this.contextTheme??v.defaultTheme;return this.invertTheme&&(e=function(e){return e.includes("light")?e.replace("light","dark"):e.replace("dark","light")}(e)),e}get contextTheme(){return this.themeConsumer?.value?.themeId}get brandId(){return this.currentTheme?.split("-")[0]}get colorSchemeId(){return this.currentTheme?.split("-")[1]}themeChanged(){(0,a.A)()}update(e){(e.has("themeId")||e.has("invertTheme"))&&this.handleTheming(),super.update(e)}handleTheming(){if(this.currentTheme!==this.contextTheme)return this.isThemeProvider?this.themeProvider?.setValue({themeId:this.currentTheme}):(this.isThemeProvider=!0,this.themeProvider=new o.DT(this,{context:d,initialValue:{themeId:this.currentTheme}})),this.setThemeCssClasses(),void this.themeChanged();this.isThemeProvider&&this.themeProvider&&(this.isThemeProvider=!1,this.removeController(this.themeProvider),this.themeProvider=void 0,this.setThemeCssClasses(),this.themeChanged())}setThemeCssClasses(){const e=this.currentTheme!==this.contextTheme;for(const t of i)this.classList.toggle(`vcdk-theme-${t}`,e&&this.brandId===t);this.classList.toggle("vcdk-mode-dark",e&&"dark"===this.colorSchemeId)}static finalizeStyles(e){return e?Array.isArray(e)?(e.unshift(c,l),n.WF.finalizeStyles(e)):n.WF.finalizeStyles([c,l,e]):n.WF.finalizeStyles([c,l])}}v.version="9.16.0",v.defaultTheme="volvo-light",p([(0,s.MZ)({type:String,reflect:!0})],v.prototype,"themeId",void 0),p([(0,s.MZ)({type:Boolean,attribute:"invert-theme",reflect:!0})],v.prototype,"invertTheme",void 0)}}]);
